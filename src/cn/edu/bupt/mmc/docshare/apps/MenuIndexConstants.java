...
/**
 * Constant int values for all menu items. Some of these menu items denote
 * operations which can be performed by {@link OperationProcessor}.
 * 
...
public interface MenuIndexConstants {
    ...
    int FILE_EXIT = 9;
    int EDIT = 67;
    int EDIT_PRE_PAGE = 68;
    int EDIT_NEXT_PAGE = 69;
    int COLOR = 10;
    int COLOR_ADJUST = 11;
