							...
							new DialogInterface.OnClickListener() {
								...
								//	SaveUserDate();
									...
									if(remoteIp.getText()!=null){
										...
										Constants.prefix="http://"+Constants.registarIp+":8888/MediaConf/";
									}
...
//											editor.putString("remoteIp", null);
										...
										System.out.println(Constants.prefix+"userLogin.do?method=login");

										// 在工作线程中执行耗时任务，防止UI线程阻塞
										LoginThread httpThread = new LoginThread(loginHandler);
										// 10.0.2.2为电脑对于模拟器而言的IP地址。
										httpThread.doStart(Constants.prefix+"userLogin.do?method=login",params, Login.this);
    ...
    private Handler loginHandler=new Handler(){
        public void handleMessage(Message message) {
            switch (message.what) {
            case 1://程序执行正常
            	Intent intent = new Intent(Login.this,PadActivity.class);
