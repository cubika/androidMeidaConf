				...
				public void onClick(View v) {
					...
					case 6:
						...
						threeTask.execute("http://"
								...
								+ PadActivity.confId + "&screen3UserId="
								+ tableRow.getCellValue(0).value);
						break;
					case 7:
						if(tableRow.getCellValue(2).value.toString().equals("OffLine")){
						...
						fourTask.execute("http://"
								...
								+ PadActivity.confId + "&screen4UserId="
								+ tableRow.getCellValue(0).value);
						break;
					case 8:
						if(tableRow.getCellValue(2).value.toString().equals("OffLine")){
						...
						fiveTask.execute("http://"
								...
								+ PadActivity.confId + "&screen5UserId="
								+ tableRow.getCellValue(0).value);
						break;
					case 9:
						if(tableRow.getCellValue(2).value.toString().equals("OffLine")){
						...
						sixTask.execute("http://"
								...
								+ PadActivity.confId + "&screen6UserId="
								+ tableRow.getCellValue(0).value);
						break;
