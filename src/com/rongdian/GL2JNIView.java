...
public class GL2JNIView extends GLSurfaceView {
	...
	static class Renderer implements GLSurfaceView.Renderer {
		...
		public synchronized void setOpenGLESDisplay(long term) {
			this.term = term;
		}

		public synchronized void onDrawFrame(GL10 gl) {
			if (this.term == 0 || this.width <= 0 || this.height <= 0) {
				return;
			}

			RtpAvTerm.ravtRemoteVideoInitRenderer(this.term, this.width,
					this.height);
			RtpAvTerm.ravtRemoteVideoRender(this.term);
		}
