				 ...
				 DialogInterface.OnClickListener addGroupListener=new DialogInterface.OnClickListener(){
						...
						public void onClick(DialogInterface dialog, int which) {
							if(which==DialogInterface.BUTTON_POSITIVE){
								...
								new GroupTask().execute("http://" + Constants.registarIp
										+ ":8888/MediaConf/cataManage.do?method=newCata&userID="
										+ ContactManageActivity.userId+"&cataName="+newGroup.getText().toString().trim());
		              ...
		              DialogInterface.OnClickListener childListener=new DialogInterface.OnClickListener(){
						...
						public void onClick(DialogInterface dialog, int which) {
							if(which==DialogInterface.BUTTON_POSITIVE){	//删除好友
								dialog.dismiss();
								new GroupTask().execute("http://" + Constants.registarIp
										+ ":8888/MediaConf/cataManage.do?method=deleteFriend&cataID="+mContactGroupIDS.get(groupPosition)
		              ...
		              listview.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> arg0, View arg1,
							...
							if(arg2==0){ //重命名
								 ...
								 DialogInterface.OnClickListener renameGroupListener=new DialogInterface.OnClickListener(){
										...
										public void onClick(DialogInterface dialog, int which) {
											if(which==DialogInterface.BUTTON_POSITIVE){
												...
												//提交
												new GroupTask().execute("http://" + Constants.registarIp
														+ ":8888/MediaConf/cataManage.do?method=updateCataName&userID="
														+ ContactManageActivity.userId+"&cataID="+mContactGroupIDS.get(groupPosition)
								...
								bundle.putString("groupID", mContactGroupIDS.get(groupPosition).toString());
								bundle.putString("userID", ContactManageActivity.userId);
								...
								startActivity(intent);
					              ...
					              DialogInterface.OnClickListener deleteListener=new DialogInterface.OnClickListener(){
										...
										public void onClick(DialogInterface dialog, int which) {
											if(which==DialogInterface.BUTTON_POSITIVE){
												dialog.dismiss();
												new DeleteGroupTask().execute("http://" + Constants.registarIp
														+ ":8888/MediaConf/cataManage.do?method=deleteCata&userID="
														+ ContactManageActivity.userId+"&cataID="+mContactGroupIDS.get(groupPosition));
			...
			if (count == 1) {
				...
				try {
					...
					for (int i = 0; i < length; i++) {
						...
						new GetFriendTask().execute("http://"
